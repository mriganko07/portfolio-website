                  ...
                  <div className="md:col-span-2">
                    <div className="flex flex-col gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-white font-semibold flex items-center gap-2">
                          <span className="text-blue-400 font-bold">✓</span> {project.institution}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-900/50 rounded-xl p-4 mb-6 border border-gray-700">
                      <h4 className="text-sm font-semibold text-blue-300 mb-3 flex items-center gap-2">
                        <span className="text-teal-400">→</span> Project Goal
                      </h4>
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-blue-300 mb-3 flex items-center gap-2">
                        <span className="text-teal-400">★</span> Key Highlights
                      </h4>
